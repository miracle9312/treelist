...
document.write("<div id='ColorPicker' style='z-index: 150; opacity:1;-moz-opacity:1;filter:alpha(opacity=100);position:absolute; left:0px; top:0px;background:#efefef;border:1px solid #cccccc;padding:10px 20px;display:none;'>")
document.write("<div id='divTitle' style='cursor: move;'><b>颜色选择</b></div>")
...
function CreateCPBtn(){
    document.write("<img src=\"Rect.gif\" style=\" align=\"absmiddle\" onClick=\"showColorPicker(this,event)\">")
}
function showColorPicker(sBtnObj,event) {
...
//var theSBtnObj=document.getElementById("choosecolor");
function setColor(){
	//$(theInputName).value = $("SelColor").value;
	var test=$("SelColor").value;
	$("choosecolor").style.backgroundColor=$("SelColor").value;
	$("ColorPicker").style.display="none";
	ctx_fake.strokeStyle=$("SelColor").value;
}
